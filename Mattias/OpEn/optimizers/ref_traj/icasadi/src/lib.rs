...
//!
//! Generated at: 2020-03-05 11:55:07.886775
//!
...
const NUM_DECISION_VARIABLES: usize = 4;
...
extern "C" {
    fn cost_function_ref_traj(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_ref_traj(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_ref_traj(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_ref_traj(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
