///
/// Auto-generated TCP server for optimizer: ref_traj
/// Generated at: 2020-03-05 11:55:09.309217
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != REF_TRAJ_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != REF_TRAJ_NUM_PARAMETERS {
