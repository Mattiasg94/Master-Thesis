 ...
 *   + n2: 3
 *
 * Generated at: 2020-03-17 13:00:46.059182
 *
 */
#include <stdlib.h>
 ...
 */
extern int phi_KWKkIXJQlPqFxFbHUXmu(
 ...
 */
extern int grad_phi_KWKkIXJQlPqFxFbHUXmu(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_KWKkIXJQlPqFxFbHUXmu(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_KWKkIXJQlPqFxFbHUXmu(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_KWKkIXJQlPqFxFbHUXmu(
        args__,
        result_space_cost,
...
int grad_cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_KWKkIXJQlPqFxFbHUXmu(
        args__,
        result_space_grad,
...
int mapping_f1_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_KWKkIXJQlPqFxFbHUXmu
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_KWKkIXJQlPqFxFbHUXmu(
        args__,
        result_space_f1,
...
int mapping_f2_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_KWKkIXJQlPqFxFbHUXmu
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_KWKkIXJQlPqFxFbHUXmu(
        args__,
        result_space_f2,
