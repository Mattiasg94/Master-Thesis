...
//
// Generated at: 2020-03-05 16:01:15.601190
//
...
pub const REF_TRAJ_TILDE_NUM_DECISION_VARIABLES: usize = 20;

/// Number of parameters
pub const REF_TRAJ_TILDE_NUM_PARAMETERS: usize = 44;

/// Number of parameters associated with augmented Lagrangian
pub const REF_TRAJ_TILDE_N1: usize = 1;

/// Number of penalty constraints
pub const REF_TRAJ_TILDE_N2: usize = 3;
...
pub fn initialize_solver() -> AlmCache {
    let panoc_cache = PANOCCache::new(REF_TRAJ_TILDE_NUM_DECISION_VARIABLES, EPSILON_TOLERANCE, LBFGS_MEMORY);
    let alm_cache = AlmCache::new(panoc_cache, REF_TRAJ_TILDE_N1, REF_TRAJ_TILDE_N2);
...
pub fn solve(
    ...
    assert_eq!(p.len(), REF_TRAJ_TILDE_NUM_PARAMETERS, "Wrong number of parameters (p)");
    assert_eq!(u.len(), REF_TRAJ_TILDE_NUM_DECISION_VARIABLES, "Wrong number of decision variables (u)");
