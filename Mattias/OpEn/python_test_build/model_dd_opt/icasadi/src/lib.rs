...
//!
//! Generated at: 2020-02-25 15:23:15.709345
//!
...
const NUM_DECISION_VARIABLES: usize = 44;
...
pub fn grad(u: &[f64], xi: &[f64], static_params: &[f64], cost_jacobian: &mut [f64]) -> i32 {
    ...
    unsafe {
        grad_cost_function_model_dd_opt(
            arguments.as_ptr(),
            grad.as_mut_ptr()
        ) as i32
    }
...
pub fn mapping_f1(
    ...
    unsafe {
         mapping_f1_function_model_dd_opt(
            arguments.as_ptr(),
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_model_dd_opt(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
