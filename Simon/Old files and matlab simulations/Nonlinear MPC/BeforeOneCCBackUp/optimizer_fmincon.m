function [Z,fval,exitflag,timerVal] = optimizer_fmincon(xk,uk,dt,dv,dw,Z0,...
                ...
                dist_cont,road_radius,obstacles_lanes,plot_x_curv,plot_y_curv,obstacle_radius,warmstart)
...
obj_fun = @(Z) objective_func(dt,Z,MQ,MR,MR_jerk,N,obstacles,obstacles_u,lines_st,x_offset,y_offset,lane_border_max,lane_border_min,xr,lanewidth,dist_cont,obstacle_radius);
nonl_con = @(Z) nonlcon(Z,N,xk,uk,dt,obstacles,obstacles_u,r_obs,xr,r_safety_margin,dist_cont,lines_st,lanewidth,x_offset,y_offset,lane_border_min,road_radius,obstacles_lanes,plot_x_curv,plot_y_curv,obstacle_radius);
