...
dv = 0.05;              % Max acceleration during one timestep
dw = 0.05;              % Max angular acceleration during one timestep
...
if test_scenario
    ...
    % NOTERA ATT DU MÅSTE ÄNDRA X I GET_Y_LANE
    ...
    xr = [Length; get_y_from_lane(reference_lane_number, Length, plot_x_curv,plot_y_curv,lanewidth) ; -pi/8];       % Reference state
