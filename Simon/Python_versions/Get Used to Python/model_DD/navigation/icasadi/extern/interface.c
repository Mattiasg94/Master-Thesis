 ...
 *   + n2: 0
 *
 * Generated at: 2020-02-25 08:58:15.078506
 *
 */
#include <stdlib.h>
...
#define NU_NAVIGATION 30

/* Number of static parameters */
#define NP_NAVIGATION 3
 ...
 */
extern int phi_WChZFyWIugAtlPXTcLjU(
 ...
 */
extern int grad_phi_WChZFyWIugAtlPXTcLjU(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_WChZFyWIugAtlPXTcLjU(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_WChZFyWIugAtlPXTcLjU(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 * |------------------- uxip_space ------------------------------|
 */
static casadi_real uxip_space[NU_NAVIGATION
                              +NXI_NAVIGATION
                              +NP_NAVIGATION];
...
static void copy_args_into_uxip_space(const casadi_real** arg) {
    ...
    for (i=0; i<NXI_NAVIGATION; i++) uxip_space[NU_NAVIGATION+i] = arg[1][i];  /* copy xi */
    for (i=0; i<NP_NAVIGATION; i++)  uxip_space[NU_NAVIGATION+NXI_NAVIGATION+i] = arg[2][i];  /* copy p  */
}
...
static void copy_args_into_up_space(const casadi_real** arg) {
    int i;
    for (i=0; i<NU_NAVIGATION; i++) uxip_space[i] = arg[0][i];  /* copy u  */
    for (i=0; i<NP_NAVIGATION; i++) uxip_space[NU_NAVIGATION+NXI_NAVIGATION+i] = arg[1][i];  /* copy p  */
}
...
int cost_function_navigation(const casadi_real** arg, casadi_real** res) {
    const casadi_real* args__[COST_SZ_ARG_NAVIGATION] =
             {uxip_space,  /* :u  */
              uxip_space + NU_NAVIGATION,  /* :xi  */
              uxip_space + NU_NAVIGATION + NXI_NAVIGATION};  /* :p  */
    copy_args_into_uxip_space(arg);

    result_space_cost[0] = res[0];
    return phi_WChZFyWIugAtlPXTcLjU(
        args__,
        result_space_cost,
...
int grad_cost_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_WChZFyWIugAtlPXTcLjU(
        args__,
        result_space_grad,
...
int mapping_f1_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_WChZFyWIugAtlPXTcLjU
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_WChZFyWIugAtlPXTcLjU(
        args__,
        result_space_f1,
...
int mapping_f2_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_WChZFyWIugAtlPXTcLjU
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_WChZFyWIugAtlPXTcLjU(
        args__,
        result_space_f2,
