...
//
// Generated at: 2020-03-13 11:49:05.658363
//
...
pub fn initialize_solver() -> AlmCache {
    let panoc_cache = PANOCCache::new(REF_TRAJ_NUM_DECISION_VARIABLES, EPSILON_TOLERANCE, LBFGS_MEMORY);
    let alm_cache = AlmCache::new(panoc_cache, REF_TRAJ_N1, REF_TRAJ_N2);
...
pub fn solve(
    ...
    assert_eq!(p.len(), REF_TRAJ_NUM_PARAMETERS, "Wrong number of parameters (p)");
    assert_eq!(u.len(), REF_TRAJ_NUM_DECISION_VARIABLES, "Wrong number of decision variables (u)");
