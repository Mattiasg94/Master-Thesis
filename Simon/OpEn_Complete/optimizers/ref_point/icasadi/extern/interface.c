 ...
 *   + n2: 3
 *
 * Generated at: 2020-03-13 12:16:52.969538
 *
 */
#include <stdlib.h>
 ...
 */
extern int phi_kMghsVZrMDUmhSGiBatr(
 ...
 */
extern int grad_phi_kMghsVZrMDUmhSGiBatr(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_kMghsVZrMDUmhSGiBatr(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_kMghsVZrMDUmhSGiBatr(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_kMghsVZrMDUmhSGiBatr(
        args__,
        result_space_cost,
...
int grad_cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_kMghsVZrMDUmhSGiBatr(
        args__,
        result_space_grad,
...
int mapping_f1_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_kMghsVZrMDUmhSGiBatr
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_kMghsVZrMDUmhSGiBatr(
        args__,
        result_space_f1,
...
int mapping_f2_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_kMghsVZrMDUmhSGiBatr
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_kMghsVZrMDUmhSGiBatr(
        args__,
        result_space_f2,
