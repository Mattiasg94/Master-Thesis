...
def convert_input(uv,uw):   # Move to arduino
    # 2/0.07 =~ 28,57143
...
# ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
    ...
    newMeasurement = [x_init,y_init,theta_init] # GET_MEASUREMENT()
    x_init, y_init, theta_init, P_t = KalmanFilter(P_t,R_t,Q_t,X_hat_t,u_star[0],u_star[1],newMeasurement,ts)    # Using u_star since uv uw isn't iniitalized prior to this line. Should us dt instead of ts later.
